                    ...
                    <form action="{{ route('clientes.update', $cliente->id) }}" method="post">
                        ...
                        <fieldset class="border-2 rounded p-6">
                            ...
                            <div class="bg-gray-100 px-4 py-3 mb-4 rounded overflow-hidden">
                                ...
                                <input type="tel" name="tel_com" id="tel_com" value="{{ $cliente->tel_com }}" class="w-full rounded">
                            </div>
                            <div class="bg-gray-100 px-4 py-3 mb-4 rounded overflow-hidden">
                                <input type="submit" value="Confirmar" class="bg-blue-500 text-white rounded p-2 w-32">
                            </div>
                        </fieldset>
                    </form>
